<template lang="pug">
.carousel
  .carousel__title.h2.highlight Notable Incubees
  ...
  .carousel__track
    ...
    .carousel__track__content.current
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          a(target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/garbagemanbd" uk-icon="icon: facebook; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://twitter.com/GARBAGEMANbd" uk-icon="icon: twitter; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/garbageman/" uk-icon="icon: linkedin; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/garbagemanbd/" uk-icon="icon: instagram; ratio: 1.5")
    ...
    .carousel__track__content
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          a(target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/amarlab.bd/" uk-icon="icon: facebook; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/amarlab/" uk-icon="icon: linkedin; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/amarlab.bd/" uk-icon="icon: instagram; ratio: 1.5")
    ...
    .carousel__track__content
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          a(target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/avijatrik" uk-icon="icon: facebook; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/avijatrik/" uk-icon="icon: linkedin; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/avijatrik.tourism/" uk-icon="icon: instagram; ratio: 1.5")
    ...
    .carousel__track__content
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          ...
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/broqu%C3%A9/" uk-icon="icon: linkedin; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/broque.af/" uk-icon="icon: instagram; ratio: 1.5")
    ...
    .carousel__track__content
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/maxtapwater/" uk-icon="icon: linkedin; ratio: 1.5")
    ...
    .carousel__track__content
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          a(target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/transgenderempowerment/" uk-icon="icon: facebook; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/transgenderempowerment/" uk-icon="icon: linkedin; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/transend.bd/" uk-icon="icon: instagram; ratio: 1.5")
    ...
    .carousel__track__content
      ...
      .carousel__track__content__texts
        ...
        .carousel__track__content__texts__socials
          a(target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/wizkitglobal" uk-icon="icon: facebook; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/wizkitglobal/" uk-icon="icon: linkedin; ratio: 1.5")
          a(target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/wizkitglobal/" uk-icon="icon: instagram; ratio: 1.5")
