<template>
  <div class="success-popup">
    <div class="success-popup__container">
      ...
      <p>
        Thank you for submitting your application for the YY Goshthi Incubation
        Program Spring 2022 Cohort.
      </p>
      <br />
      <p>
        We have sent you a confirmation email. If you haven't received any
        confirmation email, please email
        <a href="mailto:mazbah@yy.ventures" target="_blank"
          >mazbah@yy.ventures</a
        >
        or contact +8801797332722
      </p>
