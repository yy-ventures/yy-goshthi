<template>
    <div class="eligibility">
        <div class="eligibility__heading-container">
            <h1>Eligibility</h1>
        </div>
        <div class="eligibility__box-container">
            <div class="eligibility__box-container--box-1 box faded_out">
                <!-- <h1>1</h1> -->
                <h2 class="heading-1">The legal status of business</h2>
                <p>The program has primarily been designed for the needs of Social Businesses; however, non-profits, for-profits, co-operatives, and community contribution businesses are all eligible as long as they serve a crucial social or environmental cause and are willing to incorporate a Social Business model moving forward.</p>
            </div>
