<template>
  <div class="footer">
    <div class="footer__yy-goshti">
      ...
      />
      <p>
        YY Goshthi is a Social Business incubation program that helps socially &
        environmentally conscious entrepreneurs to launch their minimum viable
        product and raise the needed seed capital.
      </p>
    </div>
    ...
    <div class="footer__powered">
      ...
      />
      <p>
        Netherlands Enterprise Agency encourages entrepreneurs in sustainable,
        agrarian, innovative and international business. It helps with grants,
        finding business partners, know-how and compliance with laws and
        regulations.
      </p>
    </div>
    <div class="footer__created">
      ...
      />
      <p>
        YY Ventures is an incubation and investment Social Business supporting
        early-stage entrepreneurs who are fighting carbon emission, poverty and
        unemployment.
      </p>
    </div>
    <div class="footer__follow-ventures">
      ...
      <a href="https://www.linkedin.com/company/yyventures" target="_blank"
        >LinkedIn</a
      >
      <a href="https://www.instagram.com/yyventures/" target="_blank"
        >Instagram</a
      >
...
.footer {
  ...
  a {
    ...
    &:hover {
      color: #f6d04a;
      border-bottom: 1px solid #f6d04a;
    }
  }
